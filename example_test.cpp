...
TEST_F(SortTest, quicksort_10_array_size) {
    arr_10;
    size_t vec_size = arr_10.size();
...
TEST_F(SortTest, quicksort_10000_array_size) {
    arr_10000;
    size_t vec_size = arr_10000.size();
    quicksort(arr_10000, 0, arr_10000.size() - 1);
    for (int i = 1; i < vec_size; i++) {
        EXPECT_TRUE(arr_10000[i - 1] <= arr_10000[i]);
    }
}

TEST_F(SortTest, quicksort_10_) {
    arr_10;
...
TEST_F(SortTest, quicksort_10000_) {
    arr_10000;
